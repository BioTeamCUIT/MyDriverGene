...
from Utils.HGDataset_KEGG_multiomic import HGDataset
...
class Trainer:
    ...
    def run(self, data):
        ...
        for fold, (train_mask, val_mask) in enumerate(splits):
            # if self.model_name == 'HGT_KEGG_multiomic':
            ...
            # elif self.model_name == 'HAN_KEGG_multiomic':
