...
class HGDataset(InMemoryDataset):
    ...
    def processed_dir(self) -> str:
        return os.path.join(self.root, "ProcessedData_KEGG_PPI_Meth_Expr")
    ...
    def construct_gene_feature(self, unique_gene_id):
        """
        Note: 1.Some genes do not have omic feature, consider removing these genes
        ...
        omic_feature = omic_feature.iloc[:, 16:]
